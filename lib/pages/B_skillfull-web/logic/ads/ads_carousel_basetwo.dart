...
class AdsCarouselBaseTwo extends StatefulWidget {
  const AdsCarouselBaseTwo({super.key});

  @override
  _AdsCarouselBaseTwoState createState() => _AdsCarouselBaseTwoState();
}

class _AdsCarouselBaseTwoState extends State<AdsCarouselBaseTwo> {
  List<AppAd> ads = [];
  bool showCarousel =
  ...
  Future<List<AppAd>> fetchAdsForUser(String userType) async {
    var adsQuery = FirebaseFirestore.instance.collection('ads2');
