...
import 'package:buddy/pages/B_skillfull-web/onboarding/_Both_onboarding/both_onboarding_items.dart';
import 'package:flutter/material.dart';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';
import 'package:lottie/lottie.dart';

//stfl enter
class BothOnboardingview extends StatefulWidget {
  const BothOnboardingview({super.key});

  @override
  State<BothOnboardingview> createState() => _BothOnboardingViewState();
}

class _BothOnboardingViewState extends State<BothOnboardingview> {
  final controller = BothOnboardingItems();
          ...
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
              builder: (context) => SplashScreenTo(
                  // screen: WelcomeSplashscreen(userType: 'both'),
                  screen: SkillfullHomePage(
                userType: 'both',
