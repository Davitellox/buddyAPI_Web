...
import 'package:buddy/pages/B_skillfull-web/onboarding/_Client_onboarding/client_onboarding_items.dart';
...
class ClientOnboardingview extends StatefulWidget {
  const ClientOnboardingview({super.key});

  @override
  State<ClientOnboardingview> createState() => _ClientOnboardingViewState();
}

class _ClientOnboardingViewState extends State<ClientOnboardingview> {
  final controller = ClientOnboardingItems();
          ...
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
              builder: (context) => SplashScreenTo(
                // screen: WelcomeSplashscreen(userType: 'client'),
                screen: SkillfullHomePage(userType: 'client'),
              ),
            ),
          );
        },
